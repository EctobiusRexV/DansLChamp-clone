...
public class BibliothequePersonnagesController extends ParentControleur implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // Un panel pour chaque personnage :
        Reflections reflections = new Reflections("sim.danslchamp.personnages");

        List<String> listNomPersonnages = new ArrayList<>(List.of("Ampère", "Volta", "Edison",
